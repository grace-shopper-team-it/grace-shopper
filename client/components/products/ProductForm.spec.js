...
describe('fields in edit form', () => {
  ...
  it('should contain 6 inputs in form', () => {
    expect(
      editCompWrapper
        .find('form')
        .render()
  ...
  it('should have specified input fields', () => {
  ...
  it('input fields value should be the currentProduct prop', () => {
    const formObject = editCompWrapper.find('form').render()
    ...
    expect(formObject.children(`input[value="${imageUrl}"]`).length).to.equal(1)
  ...
  it('should have a select element that includes existing categories', () => {
